                                                                        ...
                                                                        <td className=' position-relative'>
                                                                            {
                                                                                img ?
                                                                                    ...
                                                                                    }} className='avatar_sm position-relative' src={img && URL.createObjectURL(img)} alt="image" /> :
                                                                                    data?.image?.url ?
                                                                                        <img onClick={() => {
                                                                                            document.getElementById("img_file").click()
                                                                            ...
                                                                            <i style={{ right: '45%', top: "50%" }} className='fa-solid fa-camera text-dark position-absolute'></i>
                                                                        </td>
