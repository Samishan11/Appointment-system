    ...
    >
      <div className="sidebar-heading py-4 primary-text fs-6 fw-bold text-uppercase border-bottom">
        <Link style={{ textDecoration: "none" }} to={"/"}>
          {" "}
          <h3 className="text-light">ADMIN-DASH</h3>{" "}
        </Link>
      </div>
      <div className="list-group position-relative list-group-flush my-3">
        ...
        <Link
          id="appointment"
          to="/appointment"
          className="list-group-item list-group-item-action bg-transparent tab_btn text-light py-3"
        >
          <i className="fa-sharp fa-solid fa-plus me-2"></i>Add Appoinment
        </Link>
        <Link
          id="booking"
          to="/booking"
          className="list-group-item list-group-item-action bg-transparent tab_btn text-light py-3"
        >
          <i id="nav_active" className="fa-solid fa-calendar-days me-2" />
          Booking
        </Link>
        <Link
          id="event"
        ...
        <Link
          ...
          className="list-group-item list-group-item-action bg-transparent tab_btn text-light py-3"
        >
          <i id="nav_active" className="fa-solid fa-people-roof me-2" />
          Manage Doctor
        </Link>
        <Link
          id="user"
